...
TRADES_DIR =  "I:/testkdb/trades/" # "I:/beetroot/trades/"  # where KDB trades will live  # "I:/testkdb/trades/" #
BOOKS_DIR = "I:/testkdb/books/"  # "I:/beetroot/books/"  # where KDB books will live
...
def process_month_books(logger, month_pattern, data_path, temp_dir=EXTRACT_DIR):
    ...
    try:
        ...
        for zipped_book_filename in book_gz_csv_files:
            process_book_file(q, zipped_book_filename, parent_dir=data_path, temp_dir=temp_dir, kdb_trades_dir=BOOKS_DIR)
